...
export default function ScenePlanner(props: Props) {
  ...
  return <div className="mx-auto max-w-6xl px-6 py-9">
    ...
    <div className="mt-5 space-y-3">{scenes.map((scene) => <div key={scene.id} className="rounded-2xl border border-[var(--space-border-default)] bg-[var(--space-surface-card)] p-4 transition-colors hover:border-[var(--space-border-strong)]">
